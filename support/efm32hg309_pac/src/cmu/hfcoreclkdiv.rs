...
pub type R = crate::R<HFCORECLKDIV_SPEC>;
#[doc = "Register `HFCORECLKDIV` writer"]
pub type W = crate::W<HFCORECLKDIV_SPEC>;
#[doc = "Field `HFCORECLKDIV` reader - HFCORECLK Divider"]
pub type HFCORECLKDIV_R = crate::FieldReader<HFCORECLKDIV_A>;
...
impl crate::FieldSpec for HFCORECLKDIV_A {
    type Ux = u8;
}
impl HFCORECLKDIV_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<HFCORECLKDIV_A> {
        match self.bits {
...
pub type HFCORECLKDIV_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O, HFCORECLKDIV_A>;
impl<'a, REG, const O: u8> HFCORECLKDIV_W<'a, REG, O>
where
...
pub type HFCORECLKLEDIV_R = crate::BitReader;
#[doc = "Field `HFCORECLKLEDIV` writer - Additional Division Factor For HFCORECLKLE"]
pub type HFCORECLKLEDIV_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hfcoreclkdiv(&mut self) -> HFCORECLKDIV_W<HFCORECLKDIV_SPEC, 0> {
        HFCORECLKDIV_W::new(self)
    }
    #[doc = "Bit 8 - Additional Division Factor For HFCORECLKLE"]
    #[inline(always)]
    #[must_use]
    pub fn hfcoreclklediv(&mut self) -> HFCORECLKLEDIV_W<HFCORECLKDIV_SPEC, 8> {
...
#[doc = "High Frequency Core Clock Division Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hfcoreclkdiv::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hfcoreclkdiv::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
