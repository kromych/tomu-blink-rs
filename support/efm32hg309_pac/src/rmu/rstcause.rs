...
pub type BODUNREGRST_R = crate::BitReader;
#[doc = "Field `BODREGRST` reader - Brown Out Detector Regulated Domain Reset"]
pub type BODREGRST_R = crate::BitReader;
...
pub type EM4WURST_R = crate::BitReader;
#[doc = "Field `BODAVDD0` reader - AVDD0 Bod Reset"]
pub type BODAVDD0_R = crate::BitReader;
#[doc = "Field `BODAVDD1` reader - AVDD1 Bod Reset"]
pub type BODAVDD1_R = crate::BitReader;
impl R {
