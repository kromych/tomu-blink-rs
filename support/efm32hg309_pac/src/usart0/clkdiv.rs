...
pub type DivextR = crate::FieldReader;
#[doc = "Field `DIVEXT` writer - Extended Fractional Clock Divider"]
pub type DivextW<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type DivW<'a, REG> = crate::FieldWriter<'a, REG, 15, u16>;
impl R {
    #[doc = "Bits 3:5 - Extended Fractional Clock Divider"]
    #[inline(always)]
    pub fn divext(&self) -> DivextR {
        DivextR::new(((self.bits >> 3) & 7) as u8)
    }
    #[doc = "Bits 6:20 - Fractional Clock Divider"]
    #[inline(always)]
    pub fn div(&self) -> DivR {
        DivR::new(((self.bits >> 6) & 0x7fff) as u16)
    }
}
impl W {
    #[doc = "Bits 3:5 - Extended Fractional Clock Divider"]
    #[inline(always)]
    pub fn divext(&mut self) -> DivextW<'_, ClkdivSpec> {
        DivextW::new(self, 3)
    }
    #[doc = "Bits 6:20 - Fractional Clock Divider"]
    #[inline(always)]
