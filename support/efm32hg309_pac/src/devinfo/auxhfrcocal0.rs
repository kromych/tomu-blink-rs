...
pub type R = crate::R<AUXHFRCOCAL0_SPEC>;
...
#[doc = "AUXHFRCO calibration register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`auxhfrcocal0::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
