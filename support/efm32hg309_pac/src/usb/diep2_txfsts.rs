...
pub type R = crate::R<DIEP2_TXFSTS_SPEC>;
...
#[doc = "Device IN Endpoint x+1 Transmit FIFO Status Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`diep2_txfsts::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
