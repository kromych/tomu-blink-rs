...
pub type DOEP0DMAADDR_R = crate::FieldReader<u32>;
#[doc = "Field `DOEP0DMAADDR` writer - DMA Address"]
pub type DOEP0DMAADDR_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn doep0dmaaddr(&mut self) -> DOEP0DMAADDR_W<DOEP0DMAADDR_SPEC, 0> {
