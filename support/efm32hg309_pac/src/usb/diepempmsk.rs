...
pub type DiepempmskR = crate::FieldReader<u16>;
#[doc = "Field `DIEPEMPMSK` writer - IN EP Tx FIFO Empty Interrupt Mask Bits"]
pub type DiepempmskW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - IN EP Tx FIFO Empty Interrupt Mask Bits"]
    #[inline(always)]
    pub fn diepempmsk(&self) -> DiepempmskR {
        DiepempmskR::new((self.bits & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - IN EP Tx FIFO Empty Interrupt Mask Bits"]
    #[inline(always)]
    pub fn diepempmsk(&mut self) -> DiepempmskW<'_, DiepempmskSpec> {
        DiepempmskW::new(self, 0)
    }
}
