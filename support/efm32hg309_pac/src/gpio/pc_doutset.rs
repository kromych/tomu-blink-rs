...
pub type W = crate::W<PC_DOUTSET_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn doutset(&mut self) -> DOUTSET_W<PC_DOUTSET_SPEC, 0> {
        DOUTSET_W::new(self)
    }
...
#[doc = "Port Data Out Set Register\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pc_doutset::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
